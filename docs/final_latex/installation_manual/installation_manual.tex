...
Download or clone the repository from \href{https://github.com/umairnaeem2703/CE4011-Final-Project-Submission}{umairnaeem2703/CE4011-Final-Project-Submission}, then place it in a normal user-writable folder. Open a terminal in the repository root, which is the folder containing \texttt{README.md}, \texttt{src/}, \texttt{tests/}, and \texttt{data/}.
