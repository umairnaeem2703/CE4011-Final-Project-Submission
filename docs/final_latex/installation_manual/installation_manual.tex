...
\placeholderfigure{Terminal setup screenshot}{Screenshot of the terminal opened at the repository root after obtaining the project folder.}
...
\placeholderfigure{Launched application screenshot}{Screenshot of the Tkinter desktop application immediately after launch.}
