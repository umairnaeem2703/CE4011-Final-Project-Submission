...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/blank_model_workflow1.png}
\caption{New model selection menu for starting a blank model workflow.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/blank_model_workflow2.png}
\caption{Assign dropdown contents used to define model entities during blank-model setup.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/blank_model_workflow3.png}
\caption{Random node and member plot on the canvas for a blank model.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/static_frame_axial.png}
\caption{Static frame axial force diagram.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/static_frame_shear.png}
\caption{Static frame shear force diagram.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/static_frame_moment.png}
\caption{Static frame bending moment diagram.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/static_k.png}
\caption{Static frame stiffness matrix \(K\).}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/static_frame_individual_member.png}
\caption{Static frame individual member result plot.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{../main_report/figures/modal_analysis_settings.png}
\caption{Modal analysis settings dialog.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{../main_report/figures/modal_analysis_results_summary.png}
\caption{Modal analysis results summary.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{figures/modal_mass_matrix.png}
\caption{Modal mass matrix \(M\).}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{../main_report/figures/modal_stiffness_matrix.png}
\caption{Modal stiffness matrix \(K\) and reduced matrix view.}
\end{figure}
