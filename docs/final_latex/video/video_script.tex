...
\begin{center}
\begin{tabular}{c}
Tkinter canvas/templates/XML \(\rightarrow\) ModelBuilder \\
\(\rightarrow\) StructuralModel \(\rightarrow\) DOF/K/M/F assembly \\
\(\rightarrow\) Static or Modal solver \(\rightarrow\) result object \\
